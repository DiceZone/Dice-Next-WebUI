...
export const SETTINGS_SEARCH_ENTRIES: SettingsSearchEntry[] = [
  ...
  e('settings-heartbeat', '/cloud-services', 'cloud.title', 'settings.heartbeat_title', '云服务 雲服務 心跳 骰主 昵称 暱稱 QQ 上报 上報 在线 在線 状态 狀態 heart.dice.zone heartbeat public interval', 'settings.heartbeat_desc', false),
  e('settings-logsite', '/cloud-services', 'cloud.title', 'settings.logsite_title', '云服务 雲服務 日志站 日誌站 log site upload seal protocol', 'settings.logsite_desc', false),
  e('settings-cloud', '/cloud-services', 'nav.settings', 'cloud.title', '云服务 雲服務 cloud bdc 账号中心 帳號中心', 'cloud.desc', true),
  e('settings-cloud-keys', '/cloud-services', 'cloud.title', 'cloud.keys_title', '骰娘 密钥 密鑰 key token bdc api 账号中心 帳號中心 适配器 適配器 配置 管理 清除', 'cloud.keys_desc', true),
