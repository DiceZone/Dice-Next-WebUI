 ...
 */
export type CausalCondType = 'keyword' | 'prefix' | 'regex' | 'search' | 'user_filter' | 'group_filter' | 'cooldown' | 'counter_check';
export type CausalActionType = 'reply' | 'counter_set' | 'counter_add' | 'counter_reset' | 'api_call';
...
export declare const emptyCausalRule: CausalRule;
